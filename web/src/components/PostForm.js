...
const PostForm = props => {
  ...
  const handleChangeFile = async (imageUrl) =>{
          ...
          const res = await fetch('https://ichor-api.onrender.com/upload', {
            method: 'POST',
            body: formData,
          });
  ...
  const handleChangeFile2 = async (imageUrl2) =>{
          ...
          const res2 = await fetch('https://ichor-api.onrender.com/upload2', {
            method: 'POST',
            body: formData2,
          });
  ...
  const handleChangeFile3 = async (imageUrl3) =>{
    ...
    const res3 = await fetch('https://ichor-api.onrender.com/upload3', {
      method: 'POST',
      body: formData3,
    });
...
const ihandleChangeFile = async (iconPost) =>{
  ...
  const ires = await fetch('https://ichor-api.onrender.com/upload4', {
    method: 'POST',
    body: iformData,
  });
